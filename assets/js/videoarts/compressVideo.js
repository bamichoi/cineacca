...
const handleCompress = async (e) => {
  ...
  newFile = new File([data], `${newVideoName}.mp4`, {
    type: "video/mp4",
  ...
  window.alert(
    "La compressione video è finita! Ora puoi caricare video. Grazie per la pazienza."
  );
