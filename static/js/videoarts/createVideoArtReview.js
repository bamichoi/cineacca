...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var reviewForm=document.getElementById("review_form"),reviewContainer=document.querySelector(".reviewForm_container"),videoArtPk=reviewContainer.dataset.pk;function handelSubmitReview(e){e.preventDefault();var t=reviewForm.querySelector("#review_title"),r=reviewForm.querySelector("#review_rate"),a=reviewForm.querySelector(".full_stars"),i=reviewForm.querySelector("#score"),n=reviewForm.querySelector("#review_content"),o=new FormData,c=t.value,u=r.value,l=n.value;t.value="",r.value="",n.value="",a.style.width=0,i.innerText='"0.0"',o.append("title",c),o.append("rate",u),o.append("content",l),o.append("object_type","videoart"),_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken",_axios.default.post("/reviews/api/".concat(videoArtPk,"/create/"),o).then(function(e){var t=e.data.pk,r=e.data.title,a=e.data.rate,i=e.data.content,n=e.data.firstName,o=e.data.lastName,c=e.data.created,u=document.getElementById("reviews").querySelector(".new_review"),l=u.querySelector(".review_user__firstname"),d=u.querySelector(".review_user__lastname"),s=u.querySelector(".review_title"),v=u.querySelector(".review_rate"),_=u.querySelector(".review_content"),y=u.querySelector(".review_box__date"),m=u.querySelector(".review_like_it"),w=m.querySelector("span");u.setAttribute("id","".concat(t));var f=u.querySelector(".review_btns"),q=u.querySelector(".modify"),S=u.querySelector(".delete"),x=u.querySelector(".modify_form"),p=x.querySelector(".modify_title"),T=x.querySelector(".modify_rate"),b=x.querySelector(".modify_score"),F=x.querySelector(".modify_content"),k=x.querySelector(".review_user__firstname"),A=x.querySelector(".review_user__lastname");l.innerText=n,d.innerText=o,s.innerText="".concat(r),v.innerText=a.includes(".")?'"'.concat(a,'"'):'"'.concat(a,'.0"'),_.innerText="".concat(i),f.style.display="flex",q.setAttribute("value","".concat(t)),S.setAttribute("value","".concat(t)),y.innerText="".concat(c),m.setAttribute("data-pk","".concat(t)),w.innerText="0",k.innerText=n,A.innerText=o,b.innerText=a.includes(".")?'rating: "'.concat(a,'"'):'rating: "'.concat(a,'.0"'),p.setAttribute("value","".concat(r)),T.setAttribute("value","".concat(a)),F.innerText="".concat(i),u.hidden=!1}).catch(function(e){return console.log(e.response.data)})}reviewForm.addEventListener("submit",handelSubmitReview);
