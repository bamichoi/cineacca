...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _createForOfIteratorHelper(e,t){var r="undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(!r){if(Array.isArray(e)||(r=_unsupportedIterableToArray(e))||t&&e&&"number"==typeof e.length){r&&(e=r);var a=0,n=function(){};return{s:n,n:function(){return a>=e.length?{done:!0}:{done:!1,value:e[a++]}},e:function(e){throw e},f:n}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var o,i=!0,l=!1;return{s:function(){r=r.call(e)},n:function(){var e=r.next();return i=e.done,e},e:function(e){l=!0,o=e},f:function(){try{i||null==r.return||r.return()}finally{if(l)throw o}}}}function _unsupportedIterableToArray(e,t){if(e){if("string"==typeof e)return _arrayLikeToArray(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);return"Object"===r&&e.constructor&&(r=e.constructor.name),"Map"===r||"Set"===r?Array.from(e):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?_arrayLikeToArray(e,t):void 0}}function _arrayLikeToArray(e,t){(null==t||t>e.length)&&(t=e.length);for(var r=0,a=new Array(t);r<t;r++)a[r]=e[r];return a}var _step,reviewLikeItDivs=document.getElementsByClassName("review_like_it"),handleClickLikeIt=function(e,t){var r=e.target,a=t.dataset.pk,n=t.dataset.state,o=t.dataset.obj,i=t.querySelector("span"),l=null;l="empty"==n?"add":"remove";var u=new FormData;_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken",u.append("handleType",l),u.append("objType",o),_axios.default.post("/reviews/api/".concat(a,"/fav/"),u).then(function(e){var a=e.data.result,n=e.data.numFavUsers;"added"==a?(r.className="fas fa-heart",t.dataset.state="filled"):(r.className="far fa-heart",t.dataset.state="empty"),i.innerText="".concat(n)}).catch(function(e){return console.log(e.response.data)})},_iterator=_createForOfIteratorHelper(reviewLikeItDivs);try{var _loop=function(){var e=_step.value;e.querySelector(".review_like_it_btn").addEventListener("click",function(t){handleClickLikeIt(t,e)})};for(_iterator.s();!(_step=_iterator.n()).done;)_loop()}catch(e){_iterator.e(e)}finally{_iterator.f()}
