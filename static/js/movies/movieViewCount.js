...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var reviewContainer=document.querySelector(".reviewForm_container"),moviePk=reviewContainer.dataset.pk;_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken";var data=new FormData;_axios.default.post("/movies/api/".concat(moviePk,"/view/"),data).then(function(e){}).catch(function(e){return console.log(e.response.data)});
