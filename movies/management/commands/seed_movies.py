    ...
    def handle(self, *args, **options):
        ...
        seeder.add_entity(
            ...
            number,
            {
                ...
                "thumbnail": lambda x: f"/movie_thumbnails/{random.randint(1, 6)}.jpeg",
                "year": lambda x: random.randint(1900, 2022),
                "views": 0,
                "rating": 0,
                "user": lambda x: random.choice(all_users),
                "director": lambda x: seeder.faker.name(),
                "assistant_director": lambda x: seeder.faker.name(),
                ...
                "phonic": lambda x: seeder.faker.name(),
                "edition_secretary": lambda x: seeder.faker.name(),
                ...
                "animator": lambda x: seeder.faker.name(),
                "character_designer": lambda x: seeder.faker.name(),
            },
        )
        seeder.execute()
