...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var modifyForm=document.querySelector(".review_detail_modify_form"),modifyBtn=document.querySelector(".modify"),updateBtn=document.querySelector(".update"),cancelBtn=document.querySelector(".cancel"),reviewDetailBox=document.querySelector(".review_detail_container"),reviewModifyBox=document.querySelector(".modify_detail_container"),reviewTitle=document.querySelector(".review_detail__title"),reviewRate=document.querySelector(".review_detail__rating").querySelector("span"),reviewContent=document.querySelector(".review_detail__content"),pk=modifyBtn.value,obj=reviewDetailBox.dataset.obj;function handleClickModify(e){var t=document.querySelector(".modify_rate"),i=document.querySelector(".modify_full_stars");reviewDetailBox.style.display="none",reviewModifyBox.style.display="flex",i.style.width=20*t.value+"%";t.addEventListener("input",function(e){var t=20*e.target.value+"%";i.style.width=t}),cancelBtn.addEventListener("click",function(e){e.preventDefault(),reviewDetailBox.style.display="flex",reviewModifyBox.style.display="none"}),modifyForm.addEventListener("submit",function(e){e.preventDefault();var t=modifyForm.querySelector(".modify_title"),i=modifyForm.querySelector(".modify_rate"),o=modifyForm.querySelector(".modify_content"),r=t.value,n=i.value,a=o.value,l=obj;reviewTitle.innerText='"'.concat(r,'"'),reviewRate.innerText=n.includes(".")?"".concat(n):"".concat(n,".0"),reviewContent.innerText="".concat(a),reviewDetailBox.style.display="flex",reviewModifyBox.style.display="none";var d=new FormData;d.append("pk",pk),d.append("title",r),d.append("rate",n),d.append("content",a),d.append("object_type",l),_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken",_axios.default.post("/reviews/api/update/",d).then(function(e){return alert("la review è modificata.")}).catch(function(e){return console.log(e.response.data)})})}modifyBtn.addEventListener("click",handleClickModify);
