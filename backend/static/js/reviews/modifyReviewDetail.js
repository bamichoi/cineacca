...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var modifyBtn=document.querySelector(".modify"),updateBtn=document.querySelector(".update"),cancelBtn=document.querySelector(".cancel");function handleClickModify(e){e.target.value}modifyBtn.addEventListener("click",handleClickModify);
