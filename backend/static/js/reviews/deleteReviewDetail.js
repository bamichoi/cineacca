...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var reviewDetailBox=document.querySelector(".review_detail_container"),deleteBtn=document.querySelector(".delete"),pk=deleteBtn.value,obj=reviewDetailBox.dataset.obj;function handleClickDelete(e){if(e.preventDefault(),confirm("Vuoi veramente eliminare questo review?")){reviewDetailBox.style.display="none";var t=new FormData;t.append("pk",pk),t.append("object_type",obj),_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken",_axios.default.post("/reviews/api/delete/",t).then(function(e){alert("Il review è emliminato!")}).catch(function(e){return console.log(e.response.data)})}}deleteBtn.addEventListener("click",handleClickDelete);
