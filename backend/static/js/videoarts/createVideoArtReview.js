...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var reviewForm=document.getElementById("review_form"),reviewContainer=document.querySelector(".reviewForm_container"),videoArtPk=reviewContainer.dataset.pk;function handelSubmitReview(e){e.preventDefault();var t=reviewForm.querySelector("#review_title"),r=reviewForm.querySelector("#review_rate"),a=reviewForm.querySelector(".full_stars"),i=reviewForm.querySelector("#score"),n=reviewForm.querySelector("#review_content"),o=new FormData,c=t.value,u=r.value,l=n.value;t.value="",r.value="",n.value="",a.style.width=0,i.innerText='"0.0"',o.append("title",c),o.append("rate",u),o.append("content",l),o.append("object_type","videoart"),_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken",_axios.default.post("reviews/api/".concat(videoArtPk,"/review/create/"),o).then(function(e){var t=e.data.pk,r=e.data.title,a=e.data.rate,i=e.data.content,n=e.data.firstName,o=e.data.lastName,c=e.data.created,u=document.getElementById("reviews").querySelector(".new_review"),l=u.querySelector(".review_user__firstname"),d=u.querySelector(".review_user__lastname"),v=u.querySelector(".review_title"),s=u.querySelector(".review_rate"),_=u.querySelector(".review_content"),y=u.querySelector(".review_box__date");u.setAttribute("id","".concat(t));var m=u.querySelector(".review_btns"),w=u.querySelector(".modify"),f=u.querySelector(".delete"),q=u.querySelector(".modify_form"),S=q.querySelector(".modify_title"),x=q.querySelector(".modify_rate"),p=q.querySelector(".modify_score"),T=q.querySelector(".modify_content"),b=q.querySelector(".review_user__firstname"),F=q.querySelector(".review_user__lastname");l.innerText=n,d.innerText=o,v.innerText="".concat(r),s.innerText=a.includes(".")?'"'.concat(a,'"'):'"'.concat(a,'.0"'),_.innerText="".concat(i),m.style.display="flex",w.setAttribute("value","".concat(t)),f.setAttribute("value","".concat(t)),y.innerText="".concat(c),b.innerText=n,F.innerText=o,p.innerText=a.includes(".")?'rating: "'.concat(a,'"'):'rating: "'.concat(a,'.0"'),S.setAttribute("value","".concat(r)),x.setAttribute("value","".concat(a)),T.innerText="".concat(i),u.hidden=!1}).catch(function(e){return console.log(e.response.data)})}reviewForm.addEventListener("submit",handelSubmitReview);
