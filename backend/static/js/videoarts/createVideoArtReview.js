...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var reviewForm=document.getElementById("review_form"),reviewContainer=document.querySelector(".reviewForm_container"),videoArtPk=reviewContainer.dataset.pk,csrftoken=reviewForm.csrfmiddlewaretoken.value;function handelSubmitReview(e){e.preventDefault();var t=reviewForm.querySelector("#review_title"),r=reviewForm.querySelector("#review_rate"),n=reviewForm.querySelector(".full_stars"),a=reviewForm.querySelector("#score"),i=reviewForm.querySelector("#review_content"),o=new FormData,c=t.value,u=r.value,l=i.value;t.value="",r.value="",i.value="",n.style.width=0,a.innerText='"0.0"',o.append("title",c),o.append("rate",u),o.append("content",l),o.append("object_type","videoart"),o.append("csrfmiddlewaretoken",csrftoken),_axios.default.post("/api/".concat(videoArtPk,"/review/create/"),o).then(function(e){var t=e.data.pk,r=e.data.title,n=e.data.rate,a=e.data.content,i=e.data.firstName,o=e.data.lastName,c=e.data.created,u=document.getElementById("reviews").querySelector(".new_review"),l=u.querySelector(".review_user__firstname"),v=u.querySelector(".review_user__lastname"),d=u.querySelector(".review_title"),s=u.querySelector(".review_rate"),_=u.querySelector(".review_content"),y=u.querySelector(".review_box__date");u.setAttribute("id","".concat(t));var m=u.querySelector(".review_btns"),w=u.querySelector(".modify"),f=u.querySelector(".delete"),q=u.querySelector(".modify_form"),S=q.querySelector(".modify_title"),p=q.querySelector(".modify_rate"),x=q.querySelector(".modify_score"),b=q.querySelector(".modify_content"),T=q.querySelector(".review_user__firstname"),F=q.querySelector(".review_user__lastname");l.innerText=i,v.innerText=o,d.innerText="".concat(r),s.innerText=n.includes(".")?'"'.concat(n,'"'):'"'.concat(n,'.0"'),_.innerText="".concat(a),m.style.display="flex",w.setAttribute("value","".concat(t)),f.setAttribute("value","".concat(t)),y.innerText="".concat(c),T.innerText=i,F.innerText=o,x.innerText=n.includes(".")?'rating: "'.concat(n,'"'):'rating: "'.concat(n,'.0"'),S.setAttribute("value","".concat(r)),p.setAttribute("value","".concat(n)),b.innerText="".concat(a),u.hidden=!1}).catch(function(e){return console.log(e.response.data)})}reviewForm.addEventListener("submit",handelSubmitReview);
