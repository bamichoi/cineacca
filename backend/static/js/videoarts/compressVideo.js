...
"use strict";var _regeneratorRuntime=_interopRequireDefault(require("regenerator-runtime")),_ffmpeg=require("@ffmpeg/ffmpeg");function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,t,n,r,o,a,i){try{var u=e[a](i),c=u.value}catch(e){return void n(e)}u.done?t(c):Promise.resolve(c).then(r,o)}function _asyncToGenerator(e){return function(){var t=this,n=arguments;return new Promise(function(r,o){var a=e.apply(t,n);function i(e){asyncGeneratorStep(a,r,o,i,u,"next",e)}function u(e){asyncGeneratorStep(a,r,o,i,u,"throw",e)}i(void 0)})}}var newFile,videoInput=document.getElementById("id_video"),dT=new DataTransfer,handleCompress=function(){var e=_asyncToGenerator(_regeneratorRuntime.default.mark(function e(t){var n,r,o,a,i,u,c;return _regeneratorRuntime.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=t.target.files,r=n[0].name,o=r.slice(0,-4),a=(new Date).getTime(),i=o+a+"",console.log(i),u=(0,_ffmpeg.createFFmpeg)({log:!0}),e.next=9,u.load();case 9:return e.t0=u,e.t1=r,e.next=13,(0,_ffmpeg.fetchFile)(n[0]);case 13:return e.t2=e.sent,e.t0.FS.call(e.t0,"writeFile",e.t1,e.t2),e.next=17,u.run("-i",r,"-vcodec","h264","-crf","28","-acodec","mp3","output.mp4");case 17:c=u.FS("readFile","output.mp4"),console.log(c),newFile=new File([c],i,{type:"video/mp4",lastModified:(new Date).getTime()}),dT.items.add(newFile),videoInput.files=dT.files,console.log(videoInput.files);case 23:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}();videoInput.addEventListener("change",handleCompress);
