...
"use strict";var _regeneratorRuntime=_interopRequireDefault(require("regenerator-runtime")),_ffmpeg=require("@ffmpeg/ffmpeg");function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,t,n,r,i,a,o){try{var s=e[a](o),l=s.value}catch(e){return void n(e)}s.done?t(l):Promise.resolve(l).then(r,i)}function _asyncToGenerator(e){return function(){var t=this,n=arguments;return new Promise(function(r,i){var a=e.apply(t,n);function o(e){asyncGeneratorStep(a,r,i,o,s,"next",e)}function s(e){asyncGeneratorStep(a,r,i,o,s,"throw",e)}o(void 0)})}}var newFile,percent,videoInput=document.getElementById("id_video"),posterInput=document.getElementById("id_poster"),thumbnailInput=document.getElementById("id_thumbnail"),submitDiv=document.querySelector(".upload_submit"),submitBtn=submitDiv.querySelector("button"),progress=document.getElementById("progress"),progressBar=document.getElementById("progress_bar"),dT=new DataTransfer,handleSizeValidation=function(e){e.target.files[0].size>10485760&&(window.alert("l'immagine si deve essre meno di 10MB"),e.target.value="")},handleCompress=function(){var e=_asyncToGenerator(_regeneratorRuntime.default.mark(function e(t){var n,r,i,a,o,s,l,d,u;return _regeneratorRuntime.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(n=t.target.files,r=n[0],i=r.name,a=r.size,524288e3,!(a>524288e3)){e.next=7;break}return window.alert("Attualmente, a causa di problemi del server, il caricamento limita la capacità a 500 mb per un breve periodo. Se il problema viene risolto, allenteremo le restrizioni. Ci scusiamo per l'inconveniente."),videoInput.value="",e.abrupt("return");case 7:return window.alert("Ora inizia la compresseione video. A seconda dell'ambiente e delle dimesioni del file, potrebbe volerci parecchio tempo. Si prega di evitare di fare un altro lavoro il più possibile. Non appena è finito ti faremo sapre. Si prega di attendere fino al termine del lavoro."),submitBtn.disabled=!0,progress.hidden=!1,submitBtn.style.backgroundColor="#ced6e0",o=i.slice(0,-4),s=(new Date).getTime(),l=o+s+"",d=(0,_ffmpeg.createFFmpeg)({log:!0}),e.next=17,d.load();case 17:return e.t0=d,e.t1=i,e.next=21,(0,_ffmpeg.fetchFile)(n[0]);case 21:return e.t2=e.sent,e.t0.FS.call(e.t0,"writeFile",e.t1,e.t2),d.setProgress(function(e){var t=e.ratio;percent=Math.floor(100*t),progressBar.style.width="".concat(percent,"%"),submitBtn.innerText="Compressing... ".concat(percent,"%")}),e.next=26,d.run("-i",i,"-vcodec","h264","-crf","28","-acodec","mp3","output.mp4");case 26:u=d.FS("readFile","output.mp4"),newFile=new File([u],l,{type:"video/mp4",lastModified:(new Date).getTime()}),dT.items.length>0&&dT.items.clear(),dT.items.add(newFile),videoInput.files=dT.files,window.alert("La compressione video è finita! Ora puoi caricare video. Grazie per la pazienza."),submitBtn.innerText="Carica",submitBtn.disabled=!1,progress.hidden=!0,submitBtn.style.backgroundColor="#ca5b4c",console.log(videoInput.files[0].size);case 37:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}();videoInput.addEventListener("change",handleCompress),posterInput.addEventListener("change",handleSizeValidation),thumbnailInput.addEventListener("change",handleSizeValidation);
