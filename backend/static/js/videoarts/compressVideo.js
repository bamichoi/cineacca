...
"use strict";var _regeneratorRuntime=_interopRequireDefault(require("regenerator-runtime")),_ffmpeg=require("@ffmpeg/ffmpeg");function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,t,n,r,i,o,a){try{var s=e[o](a),d=s.value}catch(e){return void n(e)}s.done?t(d):Promise.resolve(d).then(r,i)}function _asyncToGenerator(e){return function(){var t=this,n=arguments;return new Promise(function(r,i){var o=e.apply(t,n);function a(e){asyncGeneratorStep(o,r,i,a,s,"next",e)}function s(e){asyncGeneratorStep(o,r,i,a,s,"throw",e)}a(void 0)})}}var newFile,percent,videoInput=document.getElementById("id_video"),posterInput=document.getElementById("id_poster"),thumbnailInput=document.getElementById("id_thumbnail"),submitDiv=document.querySelector(".upload_submit"),submitBtn=submitDiv.querySelector("button"),progress=document.getElementById("progress"),progressBar=document.getElementById("progress_bar"),dT=new DataTransfer,handleSizeValidation=function(e){e.target.files[0].size>10485760&&(window.alert("l'immagine si deve essre meno di 10MB"),e.target.value="")},handleCompress=function(){var e=_asyncToGenerator(_regeneratorRuntime.default.mark(function e(t){var n,r,i,o,a,s,d,l,u;return _regeneratorRuntime.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(n=t.target.files,r=n[0],i=r.name,o=r.size,1572864e3,!(o>1572864e3)){e.next=7;break}return window.alert("Il video orginale si deve essre meno di 1.5GB"),videoInput.value="",e.abrupt("return");case 7:return window.alert("Ora inizia la compresseione video. A seconda dell'ambiente e delle dimesioni del file, potrebbe volerci parecchio tempo. Si prega di evitare di fare un altro lavoro il più possibile. Non appena è finito ti faremo sapre. Si prega di attendere fino al termine del lavoro."),submitBtn.disabled=!0,progress.hidden=!1,submitBtn.style.backgroundColor="#ced6e0",a=i.slice(0,-4),s=(new Date).getTime(),d=a+s+"",l=(0,_ffmpeg.createFFmpeg)({log:!0}),e.next=17,l.load();case 17:return e.t0=l,e.t1=i,e.next=21,(0,_ffmpeg.fetchFile)(n[0]);case 21:return e.t2=e.sent,e.t0.FS.call(e.t0,"writeFile",e.t1,e.t2),l.setProgress(function(e){var t=e.ratio;percent=Math.floor(100*t),progressBar.style.width="".concat(percent,"%"),submitBtn.innerText="Compressing... ".concat(percent,"%")}),e.next=26,l.run("-i",i,"-vcodec","h264","-crf","28","-acodec","mp3","output.mp4");case 26:u=l.FS("readFile","output.mp4"),newFile=new File([u],d,{type:"video/mp4",lastModified:(new Date).getTime()}),console.log(newFile),dT.items.length>0&&dT.items.clear(),dT.items.add(newFile),videoInput.files=dT.files,console.log(videoInput.files),console.log(videoInput.value),window.alert("La compressione video è finita! Ora puoi caricare video. Grazie per la pazienza."),submitBtn.innerText="Carica",submitBtn.disabled=!1,progress.hidden=!0,submitBtn.style.backgroundColor="#ca5b4c",console.log(videoInput.files[0].size);case 40:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}();videoInput.addEventListener("change",handleCompress),posterInput.addEventListener("change",handleSizeValidation),thumbnailInput.addEventListener("change",handleSizeValidation);
