...
"use strict";var _regeneratorRuntime=_interopRequireDefault(require("regenerator-runtime")),_ffmpeg=require("@ffmpeg/ffmpeg");function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,t,r,n,i,a,o){try{var u=e[a](o),s=u.value}catch(e){return void r(e)}u.done?t(s):Promise.resolve(s).then(n,i)}function _asyncToGenerator(e){return function(){var t=this,r=arguments;return new Promise(function(n,i){var a=e.apply(t,r);function o(e){asyncGeneratorStep(a,n,i,o,u,"next",e)}function u(e){asyncGeneratorStep(a,n,i,o,u,"throw",e)}o(void 0)})}}var newFile,videoInput=document.getElementById("id_video"),submitDiv=document.querySelector(".upload_submit"),submitBtn=submitDiv.querySelector("button"),dT=new DataTransfer,handleCompress=function(){var e=_asyncToGenerator(_regeneratorRuntime.default.mark(function e(t){var r,n,i,a,o,u,s,l,d;return _regeneratorRuntime.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(r=t.target.files,n=r[0],i=n.name,a=n.size,524288e3,!(a>524288e3)){e.next=7;break}return window.alert("Il video si deve essre meno di 500MB"),videoInput.value="",e.abrupt("return");case 7:return window.alert("Ora inizia la compresseione video. A seconda dell'ambiente e delle dimesioni del file, potrebbe volerci parecchio tempo. Si prega di evitare di fare un altro lavoro il più possibile. Non appena è finito ti faremo sapre. Si prega di attendere fino al termine del lavoro."),submitBtn.innerText="Compressing...",submitBtn.disabled=!0,submitBtn.style.backgroundColor="#ced6e0",o=i.slice(0,-4),u=(new Date).getTime(),s=o+u+"",console.log(s),l=(0,_ffmpeg.createFFmpeg)({log:!0}),e.next=18,l.load();case 18:return e.t0=l,e.t1=i,e.next=22,(0,_ffmpeg.fetchFile)(r[0]);case 22:return e.t2=e.sent,e.t0.FS.call(e.t0,"writeFile",e.t1,e.t2),e.next=26,l.run("-i",i,"-vcodec","h264","-crf","28","-acodec","mp3","output.mp4");case 26:d=l.FS("readFile","output.mp4"),newFile=new File([d],s,{type:"video/mp4",lastModified:(new Date).getTime()}),dT.items.add(newFile),videoInput.files=dT.files,window.alert("La compressione video è finita! Ora puoi caricare video. Grazie per la pazienza."),submitBtn.innerText="Carica",submitBtn.disabled=!1,submitBtn.style.backgroundColor="#ca5b4c";case 34:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}();videoInput.addEventListener("change",handleCompress);
