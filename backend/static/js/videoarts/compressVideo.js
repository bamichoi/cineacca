...
"use strict";var _regeneratorRuntime=_interopRequireDefault(require("regenerator-runtime")),_ffmpeg=require("@ffmpeg/ffmpeg");function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,t,r,n,i,o,a){try{var s=e[o](a),u=s.value}catch(e){return void r(e)}s.done?t(u):Promise.resolve(u).then(n,i)}function _asyncToGenerator(e){return function(){var t=this,r=arguments;return new Promise(function(n,i){var o=e.apply(t,r);function a(e){asyncGeneratorStep(o,n,i,a,s,"next",e)}function s(e){asyncGeneratorStep(o,n,i,a,s,"throw",e)}a(void 0)})}}var newFile,percent,videoInput=document.getElementById("id_video"),submitDiv=document.querySelector(".upload_submit"),submitBtn=submitDiv.querySelector("button"),progress=document.getElementById("progress"),progressBar=document.getElementById("progress_bar"),dT=new DataTransfer,handleCompress=function(){var e=_asyncToGenerator(_regeneratorRuntime.default.mark(function e(t){var r,n,i,o,a,s,u,d,l;return _regeneratorRuntime.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(r=t.target.files,n=r[0],i=n.name,o=n.size,1048576e3,console.log(r,r.length),!(o>1048576e3)){e.next=8;break}return window.alert("Il video orginale si deve essre meno di 1GB"),videoInput.value="",e.abrupt("return");case 8:return window.alert("Ora inizia la compresseione video. A seconda dell'ambiente e delle dimesioni del file, potrebbe volerci parecchio tempo. Si prega di evitare di fare un altro lavoro il più possibile. Non appena è finito ti faremo sapre. Si prega di attendere fino al termine del lavoro."),submitBtn.disabled=!0,progress.hidden=!1,submitBtn.style.backgroundColor="#ced6e0",a=i.slice(0,-4),s=(new Date).getTime(),u=a+s+"",d=(0,_ffmpeg.createFFmpeg)({log:!1}),e.next=18,d.load();case 18:return e.t0=d,e.t1=i,e.next=22,(0,_ffmpeg.fetchFile)(r[0]);case 22:return e.t2=e.sent,e.t0.FS.call(e.t0,"writeFile",e.t1,e.t2),d.setProgress(function(e){var t=e.ratio;percent=Math.floor(100*t),progressBar.style.width="".concat(percent,"%"),submitBtn.innerText="Compressing... ".concat(percent,"%")}),e.next=27,d.run("-i",i,"-vcodec","h264","-crf","28","-acodec","mp3","output.mp4");case 27:l=d.FS("readFile","output.mp4"),newFile=new File([l],u,{type:"video/mp4",lastModified:(new Date).getTime()}),dT.items.length>0&&dT.items.clear(),dT.items.add(newFile),videoInput.files=dT.files,window.alert("La compressione video è finita! Ora puoi caricare video. Grazie per la pazienza."),submitBtn.innerText="Carica",submitBtn.disabled=!1,progress.hidden=!0,submitBtn.style.backgroundColor="#ca5b4c";case 37:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}();videoInput.addEventListener("change",handleCompress);
