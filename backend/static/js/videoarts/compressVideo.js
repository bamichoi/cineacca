...
"use strict";var _regeneratorRuntime=_interopRequireDefault(require("regenerator-runtime")),_ffmpeg=require("@ffmpeg/ffmpeg");function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,t,n,r,i,a,o){try{var u=e[a](o),s=u.value}catch(e){return void n(e)}u.done?t(s):Promise.resolve(s).then(r,i)}function _asyncToGenerator(e){return function(){var t=this,n=arguments;return new Promise(function(r,i){var a=e.apply(t,n);function o(e){asyncGeneratorStep(a,r,i,o,u,"next",e)}function u(e){asyncGeneratorStep(a,r,i,o,u,"throw",e)}o(void 0)})}}var newFile,videoInput=document.getElementById("id_video"),submitDiv=document.querySelector(".upload_submit"),submitBtn=submitDiv.querySelector("button"),dT=new DataTransfer,handleCompress=function(){var e=_asyncToGenerator(_regeneratorRuntime.default.mark(function e(t){var n,r,i,a,o,u,s,l;return _regeneratorRuntime.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=t.target.files,r=n[0],i=r.name,r.size,524288e3,window.alert("Ora inizia la compresseione video. A seconda dell'ambiente e delle dimesioni del file, potrebbe volerci parecchio tempo. Si prega di evitare di fare un altro lavoro il più possibile. Non appena è finito ti faremo sapre. Si prega di attendere fino al termine del lavoro."),submitBtn.innerText="Compressing...",submitBtn.disabled=!0,submitBtn.style.backgroundColor="#ced6e0",a=i.slice(0,-4),o=(new Date).getTime(),u=a+o+"",console.log(u),s=(0,_ffmpeg.createFFmpeg)({log:!0}),e.next=14,s.load();case 14:return e.t0=s,e.t1=i,e.next=18,(0,_ffmpeg.fetchFile)(n[0]);case 18:return e.t2=e.sent,e.t0.FS.call(e.t0,"writeFile",e.t1,e.t2),e.next=22,s.run("-i",i,"-vcodec","h264","-crf","28","-acodec","mp3","output.mp4");case 22:l=s.FS("readFile","output.mp4"),newFile=new File([l],u,{type:"video/mp4",lastModified:(new Date).getTime()}),dT.items.add(newFile),videoInput.files=dT.files,window.alert("La compressione video è finita! Ora puoi caricare video. Grazie per la pazienza."),submitBtn.innerText="Carica",submitBtn.disabled=!1,submitBtn.style.backgroundColor="#ca5b4c";case 30:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}();videoInput.addEventListener("change",handleCompress);
