...
"use strict";var _regeneratorRuntime=_interopRequireDefault(require("regenerator-runtime")),_ffmpeg=require("@ffmpeg/ffmpeg");function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,i,t,r,n,a,o){try{var s=e[a](o),l=s.value}catch(e){return void t(e)}s.done?i(l):Promise.resolve(l).then(r,n)}function _asyncToGenerator(e){return function(){var i=this,t=arguments;return new Promise(function(r,n){var a=e.apply(i,t);function o(e){asyncGeneratorStep(a,r,n,o,s,"next",e)}function s(e){asyncGeneratorStep(a,r,n,o,s,"throw",e)}o(void 0)})}}var newFile,percent,videoInput=document.getElementById("id_video"),posterInput=document.getElementById("id_poster"),thumbnailInput=document.getElementById("id_thumbnail"),submitDiv=document.querySelector(".upload_submit"),submitBtn=submitDiv.querySelector("button"),progress=document.getElementById("progress"),progressBar=document.getElementById("progress_bar"),dT=new DataTransfer,handleSizeValidation=function(e){e.target.files[0].size>10485760&&(window.alert("l'immagine si deve essre meno di 10MB"),e.target.value="")},handleCompress=function(){var e=_asyncToGenerator(_regeneratorRuntime.default.mark(function e(i){var t,r,n,a,o,s,l,d,u;return _regeneratorRuntime.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(t=i.target.files,r=t[0],n=r.name,a=r.size,1572864e3,!(a>1572864e3)){e.next=7;break}return window.alert("Il file originale dovrebbe essere meno di 1.5GB"),videoInput.value="",e.abrupt("return");case 7:return window.alert("Ora inizia la compresseione video. A seconda dell'ambiente e delle dimesioni del file, potrebbe volerci parecchio tempo. A volte, anche dopo la compressione, se la dimensione del file è troppo grande per essere gestita dal server, potrebbe essere necessario modificare l'estrazione del video originale o ridurre ulteriormente le dimensioni. Si prega di evitare di fare un altro lavoro il più possibile. Non appena è finito ti faremo sapre. Si prega di attendere fino al termine del lavoro."),submitBtn.disabled=!0,progress.hidden=!1,submitBtn.style.backgroundColor="#ced6e0",o=n.slice(0,-4),s=(new Date).getTime(),l=o+s+"",d=(0,_ffmpeg.createFFmpeg)({log:!0}),e.next=17,d.load();case 17:return e.t0=d,e.t1=n,e.next=21,(0,_ffmpeg.fetchFile)(t[0]);case 21:return e.t2=e.sent,e.t0.FS.call(e.t0,"writeFile",e.t1,e.t2),d.setProgress(function(e){var i=e.ratio;percent=Math.floor(100*i),progressBar.style.width="".concat(percent,"%"),submitBtn.innerText="Compressing... ".concat(percent,"%")}),e.next=26,d.run("-i",n,"-vcodec","libx264","-crf","30","-acodec","mp3","output.mp4");case 26:if(u=d.FS("readFile","output.mp4"),newFile=new File([u],l,{type:"video/mp4",lastModified:(new Date).getTime()}),console.log(newFile),!(newFile>15e5)){e.next=33;break}return window.alert("La compressione è completa, ma il file è ancora troppo grande per essere elaborato dal server. In questo caso, potrebbe essere necessario modificare il metodo di estrazione del file originale o ridurne le dimensioni. Tuttavia, se il problema si ripete o non è più possibile ridurre le dimensioni a causa della qualità dell'immagine, si prega di contattarci per assistenza cineacca@gmail Ti aiuteremo a caricare entro 24 ore. Ci scusiamo per gli eventuali disagi causati."),videoInput.value="",e.abrupt("return");case 33:dT.items.length>0&&dT.items.clear(),dT.items.add(newFile),videoInput.files=dT.files,console.log(videoInput.files[0].size),console.log(videoInput.files[0]),window.alert("La compressione video è finita! Ora puoi caricare video. Grazie per la pazienza."),submitBtn.innerText="Carica",submitBtn.disabled=!1,progress.hidden=!0,submitBtn.style.backgroundColor="#ca5b4c";case 43:case"end":return e.stop()}},e)}));return function(i){return e.apply(this,arguments)}}();videoInput.addEventListener("change",handleCompress),posterInput.addEventListener("change",handleSizeValidation),thumbnailInput.addEventListener("change",handleSizeValidation);
