...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _createForOfIteratorHelper(e,t){var r="undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(!r){if(Array.isArray(e)||(r=_unsupportedIterableToArray(e))||t&&e&&"number"==typeof e.length){r&&(e=r);var n=0,a=function(){};return{s:a,n:function(){return n>=e.length?{done:!0}:{done:!1,value:e[n++]}},e:function(e){throw e},f:a}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var o,i=!0,l=!1;return{s:function(){r=r.call(e)},n:function(){var e=r.next();return i=e.done,e},e:function(e){l=!0,o=e},f:function(){try{i||null==r.return||r.return()}finally{if(l)throw o}}}}function _unsupportedIterableToArray(e,t){if(e){if("string"==typeof e)return _arrayLikeToArray(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);return"Object"===r&&e.constructor&&(r=e.constructor.name),"Map"===r||"Set"===r?Array.from(e):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?_arrayLikeToArray(e,t):void 0}}function _arrayLikeToArray(e,t){(null==t||t>e.length)&&(t=e.length);for(var r=0,n=new Array(t);r<t;r++)n[r]=e[r];return n}var modifyBtns=document.getElementsByClassName("modify"),updateBtns=document.getElementsByClassName("update"),cancelBtns=document.getElementsByClassName("cancel");function handleClickModify(e){var t=e.target.value,r=document.getElementById("".concat(t)),n=r.querySelector(".review_box"),a=n.querySelector(".review_box__content_container"),o=n.querySelector(".review_box__user_container"),i=r.querySelector(".modify_box"),l=r.querySelector(".modify_form"),c=r.getElementsByClassName("modify_rate"),u=r.querySelector(".modify_score_text"),y=(r.getElementsByClassName("modify_empty_stars"),r.querySelector(".modify_full_stars")),s=r.querySelector(".cancel"),d=(r.querySelector(".update"),function(e){var t=e.target.value,r=20*t+"%";y.style.width=r,u.innerText=t.includes(".")?'rating: "'.concat(t,'"'):'rating: "'.concat(t,'.0"')});n.style.display="none",i.style.display="flex";var f,p=_createForOfIteratorHelper(c);try{for(p.s();!(f=p.n()).done;){var m=f.value;m.addEventListener("input",d),y.style.width=20*m.value+"%"}}catch(e){p.e(e)}finally{p.f()}s.addEventListener("click",function(e){e.preventDefault(),n.style.display="flex",i.style.display="none"}),l.addEventListener("submit",function(e){e.preventDefault();var r=l.querySelector(".modify_title"),c=l.querySelector(".modify_rate"),u=l.querySelector(".modify_content"),y=a.querySelector(".review_title"),s=o.querySelector(".review_rate"),d=a.querySelector(".review_content"),f=r.value,p=c.value,m=u.value,_=l.csrfmiddlewaretoken.value,v=new FormData;y.innerText="".concat(f),s.innerText=p.includes(".")?'"'.concat(p,'"'):'"'.concat(p,'.0"'),d.innerText="".concat(m),n.style.display="flex",i.style.display="none",v.append("pk",t),v.append("title",f),v.append("rate",p),v.append("content",m),v.append("object_type","videoart"),v.append("csrfmiddlewaretoken",_),_axios.default.post("/api/review/update/",v).then(function(e){return alert("Il review è modificato.")}).catch(function(e){return console.log(e.response.data)})})}var _step2,_iterator2=_createForOfIteratorHelper(modifyBtns);try{for(_iterator2.s();!(_step2=_iterator2.n()).done;){var modifyBtn=_step2.value;modifyBtn.addEventListener("click",handleClickModify)}}catch(e){_iterator2.e(e)}finally{_iterator2.f()}
