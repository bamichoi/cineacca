...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _createForOfIteratorHelper(e,r){var t="undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(!t){if(Array.isArray(e)||(t=_unsupportedIterableToArray(e))||r&&e&&"number"==typeof e.length){t&&(e=t);var n=0,a=function(){};return{s:a,n:function(){return n>=e.length?{done:!0}:{done:!1,value:e[n++]}},e:function(e){throw e},f:a}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var o,i=!0,l=!1;return{s:function(){t=t.call(e)},n:function(){var e=t.next();return i=e.done,e},e:function(e){l=!0,o=e},f:function(){try{i||null==t.return||t.return()}finally{if(l)throw o}}}}function _unsupportedIterableToArray(e,r){if(e){if("string"==typeof e)return _arrayLikeToArray(e,r);var t=Object.prototype.toString.call(e).slice(8,-1);return"Object"===t&&e.constructor&&(t=e.constructor.name),"Map"===t||"Set"===t?Array.from(e):"Arguments"===t||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)?_arrayLikeToArray(e,r):void 0}}function _arrayLikeToArray(e,r){(null==r||r>e.length)&&(r=e.length);for(var t=0,n=new Array(r);t<r;t++)n[t]=e[t];return n}var deleteBtns=document.getElementsByClassName("delete"),reviewForm=document.getElementById("review_form"),csrftoken=reviewForm.csrfmiddlewaretoken.value;function handleClickDelete(e){e.preventDefault();var r=e.target.value,t=document.getElementById("".concat(r));if(confirm("Vuoi veramente eliminare questo review?")){t.hidden=!0;var n=new FormData;n.append("pk",r),n.append("object_type","videoart"),n.append("csrfmiddlewaretoken",csrftoken),_axios.default.post("/api/review/delete/",n).then(function(e){return alert("Il review è emliminato!")}).catch(function(e){return console.log(e.response.data)})}}var _step,_iterator=_createForOfIteratorHelper(deleteBtns);try{for(_iterator.s();!(_step=_iterator.n()).done;){var deleteBtn=_step.value;deleteBtn.addEventListener("click",handleClickDelete)}}catch(e){_iterator.e(e)}finally{_iterator.f()}
