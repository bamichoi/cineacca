...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var reviewContainer=document.querySelector(".reviewForm_container"),moviePk=reviewContainer.dataset.pk;_axios.default.get("/api/movies/".concat(moviePk,"/view")).then(function(e){}).catch(function(e){return console.log(e.response.data)});
