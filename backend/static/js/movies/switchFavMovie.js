...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var reviewContainer=document.querySelector(".reviewForm_container"),InfoContainer=document.querySelector(".detail_movieInfo"),objType=InfoContainer.dataset.obj,likeItDiv=document.querySelector(".movie_like_it"),likeItBtn=document.querySelector(".movie_like_it_btn"),likeItIco=likeItBtn.querySelector("i"),handleClickLikeIt=function(){if("movie"==objType){var e=reviewContainer.dataset.pk,t=null;t="empty"==likeItDiv.dataset.state?"add":"remove",_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken";var a=new FormData;a.append("handleType",t),_axios.default.post("/movies/api/".concat(e,"/fav/"),a).then(function(e){"added"==e.data.result?(likeItIco.className="fas fa-heart",likeItDiv.dataset.state="filled"):(likeItIco.className="far fa-heart",likeItDiv.dataset.state="empty")}).catch(function(e){return console.log(e.response.data)})}else{var i=reviewContainer.dataset.pk,o=null;o="empty"==likeItDiv.dataset.state?"add":"remove",_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken";var r=new FormData;r.append("handleType",o),_axios.default.post("/videoarts/api/".concat(i,"/fav/"),r).then(function(e){"added"==e.data.result?(likeItIco.className="fas fa-heart",likeItDiv.dataset.state="filled"):(likeItIco.className="far fa-heart",likeItDiv.dataset.state="empty")}).catch(function(e){return console.log(e.response.data)})}};likeItBtn.addEventListener("click",handleClickLikeIt);
