...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var reviewContainer=document.querySelector(".reviewForm_container"),moviePk=reviewContainer.dataset.pk,likeItDiv=document.querySelector(".movie_like_it"),likeItBtn=document.querySelector(".movie_like_it_btn"),likeItIco=likeItBtn.querySelector("i"),handleClickLikeIt=function(){var e=null;e="empty"==likeItDiv.dataset.state?"add":"remove",_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken";var t=new FormData;t.append("handleType",e),_axios.default.post("/api/movies/".concat(moviePk,"/fav/"),t).then(function(e){"added"==e.data.result?(likeItIco.className="fas fa-heart",likeItDiv.dataset.state="filled"):(likeItIco.className="far fa-heart",likeItDiv.dataset.state="empty")}).catch(function(e){return console.log(e.response.data)})};likeItBtn.addEventListener("click",handleClickLikeIt);
