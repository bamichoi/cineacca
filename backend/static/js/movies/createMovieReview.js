...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var reviewForm=document.getElementById("review_form"),reviewContainer=document.querySelector(".reviewForm_container"),moviePk=reviewContainer.dataset.pk;function handelSubmitReview(e){e.preventDefault();var t=reviewForm.querySelector("#review_title"),r=reviewForm.querySelector("#review_rate"),o=reviewForm.querySelector(".full_stars"),a=reviewForm.querySelector("#score"),i=reviewForm.querySelector("#review_content"),n=new FormData,c=t.value,u=r.value,l=i.value;t.value="",r.value="",i.value="",o.style.width=0,a.innerText='"0.0"',_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken",n.append("title",c),n.append("rate",u),n.append("content",l),n.append("object_type","movie"),_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken",_axios.default.post("/reviews/api/".concat(moviePk,"/create/"),n).then(function(e){console.log(e);var t=e.data.pk,r=e.data.title,o=e.data.rate,a=e.data.content,i=e.data.created,n=document.getElementById("reviews").querySelector(".new_review"),c=n.querySelector(".review_title"),u=n.querySelector(".review_rate"),l=n.querySelector(".review_content"),d=n.querySelector(".review_box__date"),s=n.querySelector(".review_like_it"),v=s.querySelector("span");n.setAttribute("id","".concat(t));n.querySelector(".review_btns");var f=n.querySelector(".modify"),m=n.querySelector(".delete"),_=n.querySelector(".modify_form"),y=_.querySelector(".modify_title"),w=_.querySelector(".modify_rate"),S=_.querySelector(".modify_score"),q=_.querySelector(".modify_content");c.innerText="".concat(r),u.innerText=o.includes(".")?'"'.concat(o,'"'):'"'.concat(o,'.0"'),l.innerText="".concat(a),f.setAttribute("value","".concat(t)),m.setAttribute("value","".concat(t)),d.innerText="".concat(i),s.setAttribute("data-pk","".concat(t)),v.innerText="0",S.innerText=o.includes(".")?'rating: "'.concat(o,'"'):'rating: "'.concat(o,'.0"'),y.setAttribute("value","".concat(r)),w.setAttribute("value","".concat(o)),q.innerText="".concat(a),n.hidden=!1}).catch(function(e){return console.log(e.response.data)})}reviewForm.addEventListener("submit",handelSubmitReview);
