...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var reviewForm=document.getElementById("review_form"),reviewContainer=document.querySelector(".reviewForm_container"),moviePk=reviewContainer.dataset.pk,csrftoken=reviewForm.csrfmiddlewaretoken.value;function handelSubmitReview(e){e.preventDefault();var t=reviewForm.querySelector("#review_title"),r=reviewForm.querySelector("#review_rate"),o=reviewForm.querySelector(".full_stars"),n=reviewForm.querySelector("#score"),i=reviewForm.querySelector("#review_content"),a=new FormData,c=t.value,u=r.value,l=i.value;t.value="",r.value="",i.value="",o.style.width=0,n.innerText='"0.0"',a.append("title",c),a.append("rate",u),a.append("content",l),a.append("object_type","movie"),a.append("csrfmiddlewaretoken",csrftoken),_axios.default.post("/api/".concat(moviePk,"/review/create/"),a).then(function(e){var t=e.data.pk,r=e.data.title,o=e.data.rate,n=e.data.content,i=e.data.created,a=document.getElementById("reviews").querySelector(".new_review"),c=a.querySelector(".review_title"),u=a.querySelector(".review_rate"),l=a.querySelector(".review_content"),v=a.querySelector(".review_box__date");a.setAttribute("id","".concat(t));var d=a.querySelector(".review_btns"),s=a.querySelector(".modify"),m=a.querySelector(".delete"),y=a.querySelector(".modify_form"),w=y.querySelector(".modify_title"),_=y.querySelector(".modify_rate"),f=y.querySelector(".modify_score"),q=y.querySelector(".modify_content");c.innerText="".concat(r),u.innerText=o.includes(".")?'"'.concat(o,'"'):'"'.concat(o,'.0"'),l.innerText="".concat(n),d.style.display="flex",s.setAttribute("value","".concat(t)),m.setAttribute("value","".concat(t)),v.innerText="".concat(i),f.innerText=o.includes(".")?'rating: "'.concat(o,'"'):'rating: "'.concat(o,'.0"'),w.setAttribute("value","".concat(r)),_.setAttribute("value","".concat(o)),q.innerText="".concat(n),a.hidden=!1}).catch(function(e){return console.log(e.response.data)})}reviewForm.addEventListener("submit",handelSubmitReview);
