...
"use strict";var _axios=_interopRequireDefault(require("axios"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var reviewForm=document.getElementById("review_form"),reviewContainer=document.querySelector(".reviewForm_container"),moviePk=reviewContainer.dataset.pk;function handelSubmitReview(e){e.preventDefault();var t=reviewForm.querySelector("#review_title"),r=reviewForm.querySelector("#review_rate"),a=reviewForm.querySelector(".full_stars"),o=reviewForm.querySelector("#score"),i=reviewForm.querySelector("#review_content"),n=new FormData,c=t.value,u=r.value,l=i.value;t.value="",r.value="",i.value="",a.style.width=0,o.innerText='"0.0"',_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken",n.append("title",c),n.append("rate",u),n.append("content",l),n.append("object_type","movie"),_axios.default.defaults.xsrfHeaderName="X-CSRFTOKEN",_axios.default.defaults.xsrfCookieName="csrftoken",_axios.default.post("/api/".concat(moviePk,"/review/create/"),n).then(function(e){var t=e.data.pk,r=e.data.title,a=e.data.rate,o=e.data.content,i=e.data.created,n=document.getElementById("reviews").querySelector(".new_review"),c=n.querySelector(".review_title"),u=n.querySelector(".review_rate"),l=n.querySelector(".review_content"),d=n.querySelector(".review_box__date");n.setAttribute("id","".concat(t));var v=n.querySelector(".review_btns"),s=n.querySelector(".modify"),f=n.querySelector(".delete"),m=n.querySelector(".modify_form"),y=m.querySelector(".modify_title"),_=m.querySelector(".modify_rate"),w=m.querySelector(".modify_score"),S=m.querySelector(".modify_content");c.innerText="".concat(r),u.innerText=a.includes(".")?'"'.concat(a,'"'):'"'.concat(a,'.0"'),l.innerText="".concat(o),v.style.display="flex",s.setAttribute("value","".concat(t)),f.setAttribute("value","".concat(t)),d.innerText="".concat(i),w.innerText=a.includes(".")?'rating: "'.concat(a,'"'):'rating: "'.concat(a,'.0"'),y.setAttribute("value","".concat(r)),_.setAttribute("value","".concat(a)),S.innerText="".concat(o),n.hidden=!1}).catch(function(e){return console.log(e.response.data)})}reviewForm.addEventListener("submit",handelSubmitReview);
